...
(declref_expr type='([(inout T) throws -> Void]) -> (((inout T) throws -> Void) throws -> Void) throws -> ()' location=/Users/yuutas4/projects/StubKit/Sources/St
ubKit/Injector.swift:30:27 range=[/Users/yuutas4/projects/StubKit/Sources/StubKit/Injector.swift:30:27 - line:30:27] decl=Swift.(file).Sequence extension.forEach [with (substitution_map generic_signature=<Self where Self : Sequence> (substitution Self -> [(inout T) throws -> Void]))] function_ref=single)
